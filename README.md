...
| Windows | amd64, arm64 | 不支持 |
| macOS | amd64, arm64 | 不支持 |
...
### Linux/macOS
```sh
bash <(curl -Ls https://raw.githubusercontent.com/wasimzheng/s-ui/main/install.sh)
```

### Windows
1. 从 [GitHub Releases](https://github.com/wasimzheng/s-ui/releases/latest) 下载最新 Windows 版本。
2. 解压 ZIP 文件。
...
### Linux/macOS
1. 根据你的系统和架构，从 GitHub 获取最新版本 S-UI：[https://github.com/wasimzheng/s-ui/releases/latest](https://github.com/wasimzheng/s-ui/releases/latest)
2. **可选：** 获取最新版 `s-ui.sh`：[https://raw.githubusercontent.com/wasimzheng/s-ui/main/s-ui.sh](https://raw.githubusercontent.com/wasimzheng/s-ui/main/s-ui.sh)
...
### Windows
1. 从 GitHub 获取最新 Windows 版本：[https://github.com/wasimzheng/s-ui/releases/latest](https://github.com/wasimzheng/s-ui/releases/latest)
...
docker run -itd \
    ...
    --name s-ui \
    --restart=unless-stopped \
    ghcr.io/wasimzheng/s-ui
```

> 自行构建镜像

```shell
git clone https://github.com/wasimzheng/s-ui
docker build -t s-ui .
```
